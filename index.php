<?php
/*------------------------------
   SMPL CMS Template File
--------------------------------*/
// Include all system function files here
require('smpl.dev.php');
// require('smpl.stub.php');
// require('smpl.php');
//--------------------------------------------
?>
...
<html lang="en">
<head>
  <?php //Content::HtmlHeader(); ?>
  <?php Content::Space('head'); ?>
  <!-- // Code generated by the HtmlHeader()
  <title>My SMPL Site</title>
  <meta charset="utf-8">
...
<body>
  <div class="container">
    ...
    <header class="header clearfix">
      <?php Content::Space('header'); ?>
      
      <!-- 
      <div class="logo">.Simpliste</div>  //LOGO BLOCK, PRIORITY HIGH
      
      <nav class="menu_main"> //MENU BLOCK, PRIORITY MED
        <ul>
